...
const searchResults = document.querySelector('.search-results'); // searchResults.insertAdjacentHTML('beforeend', card);
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  form.addEventListener('submit', async function (event) {
    ...
    const response = await _axios.default.get("https://api.github.com/users/".concat(userName)); // console.log(response)
